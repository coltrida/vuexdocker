(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_clients_RateUser_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    console.log(this.idAudio); //   this.fetchClientsDaSaldare(this.idAudio);
    //   this.fetchClientsSaldati(this.getIdUser);
  },
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)('rate', {
    fetchClientsDaSaldare: 'fetchClientsDaSaldare' //      fetchClientsSaldati: 'fetchClientsSaldati',
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "flex justify-start align-center mt-8" }, [
