const routes = [
    ...
    { path: '/magazzino/:filialeId', abstract: true, component: () => import('../Pages/magazzino/MagazzinoFiliale'), name: 'magazzino' },
    { path: '/magazzinoCentrale', component: () => import('../Pages/magazzino/Centrale'), name: 'magazzinoCentrale' },
    { path: '/listaDdt', component: () => import('../Pages/magazzino/ListaDdt'), name: 'listaDdt' },
    ...
    { path: '/statisticheAppuntamenti', component: () => import('../Pages/statistiche/Appuntamenti'), name: 'statisticheAppuntamenti' },
    { path: '/statisticheAppuntamentiMesi', component: () => import('../Pages/statistiche/AppuntamentiMesi'), name: 'statisticheAppuntamentiMesi' },
