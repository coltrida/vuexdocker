    ...
    export default {
        ...
        data(){
            return {
                ...
                headers1: [
                    { text: 'Nome', width:200, align: 'start', sortable: false, value: 'nome', class: "indigo white--text" },
                    { text: 'Settimana', width:140, align: 'center', sortable: false, value: 'settimana', class: "indigo white--text" },
                    { text: 'lun', width:210, align: 'center', sortable: false, value: 'lun', class: "indigo white--text" },
                    { text: 'mar', width:210, align: 'center', sortable: false, value: 'mar', class: "indigo white--text" },
                    { text: 'mer', width:210, align: 'center', sortable: false, value: 'mer', class: "indigo white--text" },
                    { text: 'gio', width:210, align: 'center', sortable: false, value: 'gio', class: "indigo white--text" },
                    { text: 'ven', width:210, align: 'center', sortable: false, value: 'ven', class: "indigo white--text" },
                ],
            }
        },
